...
const descriptionsData1 = ref([
  ...
  {
    label: computed(() => t("traitDetailPage.merged")) as any,
    prop: 'calculatedMerged',
    type: 'boolean',
  },
  {
    label: computed(() => t("traitDetailPage.exclusionSelection")) as any,
    prop: 'supportExclusionOptionChoices',
    type: 'boolean'
  },
  {
    label: computed(() => t("traitDetailPage.nonConfigurableItems")) as any,
    prop: 'supportItemChoiceFiltering',
    type: 'boolean'
  },
  {
    label: computed(() => t("traitDetailPage.validityDates")) as any,
    prop: 'supportEffectivityOnOptionChoices',
    type: 'boolean'
  },
  {
    label: computed(() => t("traitDetailPage.optionAggregationRule")) as any,
    prop: 'useExplicitChoiceRuleMembership',
    type: 'boolean'
  },
  {
    label: computed(() => t("traitDetailPage.manageLocalRuleChangesIndependently")) as any,
    prop: 'manageLocalRuleChangesIndependently',
    type: 'boolean'
  },
])
const descriptionsData2 = ref([
  {
    label: computed(() => t("traitDetailPage.state")) as any,
    prop: ''
  },
  {
    label: computed(() => t("traitDetailPage.teamTemplate")) as any,
    prop: ''
  },
  {
  ...
  {
    label: computed(() => t("traitDetailPage.modified")) as any,
    prop: 'modifyer'
  },
  {
    label: computed(() => t("traitDetailPage.lifecycle")) as any,
    prop: ''
  },
  {
  ...
  {
    label: computed(() => t("traitDetailPage.creator")) as any,
    prop: 'creator'
  },
  {
