...
const tableColumns = ref<PtTableColumnsType>([
  {
    prop: "name",
    label: computed(() => t("traitDetailPage.optionSetList_name")) as any,
  ...
  {
    prop: "version",
    label: computed(() => t("traitDetailPage.optionSetList_version")) as any,
    // showOverflowTooltip: true,
    show: true,
    headerAlign: "center"
  },
  {
    prop: "state",
    label: computed(() => t("traitDetailPage.optionSetList_state")) as any,
    // showOverflowTooltip: true,
    show: true,
    headerAlign: "center"
  },
  {
    prop: "productName",
    label: computed(() => t("traitDetailPage.optionSetList_context")) as any,
    showOverflowTooltip: true,
    show: true,
    headerAlign: "center"
  },
